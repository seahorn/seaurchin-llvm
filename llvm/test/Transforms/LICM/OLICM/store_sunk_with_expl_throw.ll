...
define hidden fastcc void @cond_inc(ptr noalias nocapture noundef align 4 dereferenceable(8) %b) unnamed_addr #0 personality ptr @__gxx_personality_v0  !dbg !8 {
...
loop:                                              ; preds = %cond.cont, %start
  %iter.sroa.0.02 = phi i32 [ 0, %start ], [ %_11.0.i, %cond.cont ]
  %_11.0.i = add nuw nsw i32 %iter.sroa.0.02, 1, !dbg !29
  %_5 = load i32, ptr %0, align 4, !dbg !49
  %_6 = invoke noundef zeroext i1 @cond() #2
          to label %cond.cont unwind label %cond.unwind, !dbg !47

cond.cont: ; normal continuation
...
cond.unwind: ; exception handling
